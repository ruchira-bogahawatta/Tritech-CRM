    ...
    <div class="menu">
        ...
        <ul>
            ...
            <div class="user-account">
             ...
             <li><a href ="../manage-customer/manage-customer.php"><i class="fas fa-users"></i> Customers</a></li>
             <li><a href ="../manage-admin/manage-admin.php"><i class="fas fa-user-cog"></i> Admin Panel</a></li>
